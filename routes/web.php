...
use App\Http\Controllers\Frontend4\AuthenticationController as Frontend4AuthenticationController;
...
use App\Http\Controllers\frontEnd\Roster\AICopilotController;
use App\Http\Controllers\frontEnd\Roster\AIDocumentImportController;
use App\Http\Controllers\frontEnd\Roster\AINewClientImportController;
...
use App\Http\Controllers\frontEnd\Roster\FeedbackHubController;
...
use App\Http\Controllers\frontEnd\Roster\PortalAccessController;
...
use App\Http\Controllers\frontEnd\Roster\RosterFormBuilderController;
...
use App\Http\Controllers\frontEnd\Roster\WorkflowController;
...
use App\Http\Controllers\frontEnd\ServiceUserManagement\TaskManagementController;
...
Route::group(['middleware' => ['checkUserAuth', 'lock']], function () {
    ...
    Route::prefix('roster')->group(function () {
        ...
        Route::post('/ai-document-import/upload', [AIDocumentImportController::class, 'upload'])->middleware('throttle:10,1');
        Route::post('/ai-document-import/extract', [AIDocumentImportController::class, 'extract'])->middleware('throttle:10,1');
        Route::post('/ai-document-import/confirm', [AIDocumentImportController::class, 'confirmImport'])->middleware('throttle:10,1');
        Route::get('/ai-document-import/list', [AIDocumentImportController::class, 'list'])->middleware('throttle:30,1');
        Route::get('/ai-document-import/documents', [AIDocumentImportController::class, 'documents'])->middleware('throttle:30,1');
        Route::post('/ai-document-import/delete', [AIDocumentImportController::class, 'delete'])->middleware('throttle:20,1');
        Route::get('/ai-document-import/download/{id}', [AIDocumentImportController::class, 'download'])->middleware('throttle:30,1')->where('id', '[0-9]+');

        // AI New Client Importer
        Route::post('/ai-new-client-import/upload', [AINewClientImportController::class, 'upload'])->middleware('throttle:10,1');
        Route::post('/ai-new-client-import/extract', [AINewClientImportController::class, 'extract'])->middleware('throttle:10,1');
        Route::post('/ai-new-client-import/confirm', [AINewClientImportController::class, 'confirm'])->middleware('throttle:10,1');
        ...
        Route::get('/form-builder/submission/list', [RosterFormBuilderController::class, 'listSubmissions']);
        ...
        Route::post('/workflows/install-template', [WorkflowController::class, 'installTemplate'])->middleware('throttle:20,1');
        Route::post('/workflows/run-all', [WorkflowController::class, 'runAll'])->middleware('throttle:10,1');
        Route::post('/workflows/run-single', [WorkflowController::class, 'runSingle'])->middleware('throttle:30,1');
        ...
        // Portal Access
        Route::get('/client/portal-access', [PortalAccessController::class, 'index']);
        Route::get('/client/portal-access-list', [PortalAccessController::class, 'list'])->middleware('throttle:30,1');
        ...
        Route::post('/notifications/delete', [NotificationController::class, 'delete'])->middleware('throttle:20,1');
        Route::post('/notifications/unread-count', [NotificationController::class, 'unreadCount'])->middleware('throttle:60,1');
    ...
    Route::delete('/service/task-management/delete/{id}', [TaskManagementController::class, 'destroy'])->name('service.task-management.destroy');
    ...
    Route::get('/medication/shift-handover', [ShiftHandoverController::class, 'index'])->name('medication.shift-handover.index');
    Route::post('/medication/shift-handover', [ShiftHandoverController::class, 'store'])->name('medication.shift-handover.store');
    Route::post('/medication/shift-handover/{id}/update', [ShiftHandoverController::class, 'update'])->where('id', '[0-9]+')->name('medication.shift-handover.update');
    Route::post('/medication/shift-handover/{id}/acknowledge', [ShiftHandoverController::class, 'acknowledge'])->where('id', '[0-9]+')->name('medication.shift-handover.acknowledge');
    // React/Inertia version (isolated; legacy above untouched)
    Route::get('/medication/shift-handover-react', [ShiftHandoverController::class, 'indexReact'])->name('medication.shift-handover.react');
    Route::post('/medication/shift-handover-react', [ShiftHandoverController::class, 'storeReact'])->name('medication.shift-handover.react.store');
    Route::post('/medication/shift-handover-react/{id}/acknowledge', [ShiftHandoverController::class, 'acknowledgeReact'])->where('id', '[0-9]+')->name('medication.shift-handover.react.acknowledge');

    // Medication Management — Medication Round (reuses the existing /client/mar-administer endpoint to record doses)
    Route::get('/medication/medication-round', [MedicationRoundController::class, 'index'])->name('medication.medication-round.index');
    Route::post('/medication/medication-round/record', [MedicationRoundController::class, 'record'])->name('medication.medication-round.record');
    // React/Inertia version (isolated; legacy above untouched)
    Route::get('/medication/medication-round-react', [MedicationRoundController::class, 'indexReact'])->name('medication.medication-round.react');
    Route::post('/medication/medication-round-react/record', [MedicationRoundController::class, 'recordReact'])->name('medication.medication-round.react.record');
    // Experimental copy of the round page (for trying alternative UIs; shares the same data + record logic)
    Route::get('/medication/medication-round-lab', [MedicationRoundController::class, 'indexReactLab'])->name('medication.medication-round.lab');
    Route::post('/medication/medication-round-lab/record', [MedicationRoundController::class, 'recordReactLab'])->name('medication.medication-round.lab.record');
    Route::get('/medication/medication-round-lab2', [MedicationRoundController::class, 'indexReactLab2'])->name('medication.medication-round.lab2');
    Route::post('/medication/medication-round-lab2/record', [MedicationRoundController::class, 'recordReactLab2'])->name('medication.medication-round.lab2.record');
    Route::get('/medication/medication-round-lab1-1', [MedicationRoundController::class, 'indexReactLab11'])->name('medication.medication-round.lab1-1');
    Route::post('/medication/medication-round-lab1-1/record', [MedicationRoundController::class, 'recordReactLab11'])->name('medication.medication-round.lab1-1.record');
    Route::get('/medication/medication-round-lab1-2', [MedicationRoundController::class, 'indexReactLab12'])->name('medication.medication-round.lab1-2');
    Route::post('/medication/medication-round-lab1-2/record', [MedicationRoundController::class, 'recordReactLab12'])->name('medication.medication-round.lab1-2.record');
    Route::get('/medication/medication-round-lab1-3', [MedicationRoundController::class, 'indexReactLab13'])->name('medication.medication-round.lab1-3');
    Route::post('/medication/medication-round-lab1-3/record', [MedicationRoundController::class, 'recordReactLab13'])->name('medication.medication-round.lab1-3.record');
    Route::get('/medication/medication-round-lab1-4', [MedicationRoundController::class, 'indexReactLab14'])->name('medication.medication-round.lab1-4');
    Route::post('/medication/medication-round-lab1-4/record', [MedicationRoundController::class, 'recordReactLab14'])->name('medication.medication-round.lab1-4.record');
    Route::get('/medication/medication-round-lab1-4-1', [MedicationRoundController::class, 'indexReactLab141'])->name('medication.medication-round.lab1-4-1');
    Route::post('/medication/medication-round-lab1-4-1/record', [MedicationRoundController::class, 'recordReactLab141'])->name('medication.medication-round.lab1-4-1.record');
    Route::get('/medication/medication-round-lab1-4-2', [MedicationRoundController::class, 'indexReactLab142'])->name('medication.medication-round.lab1-4-2');
    Route::post('/medication/medication-round-lab1-4-2/record', [MedicationRoundController::class, 'recordReactLab142'])->name('medication.medication-round.lab1-4-2.record');
    Route::post('/medication/medication-round-lab1-4-2/end-round', [MedicationRoundController::class, 'endReactLab142'])->name('medication.medication-round.lab1-4-2.end');
    Route::post('/medication/medication-round-lab1-4-2/reopen-round', [MedicationRoundController::class, 'reopenReactLab142'])->name('medication.medication-round.lab1-4-2.reopen');
    Route::post('/medication/medication-round-lab1-4-2/flag-handover', [MedicationRoundController::class, 'flagToHandoverLab142'])->name('medication.medication-round.lab1-4-2.flag-handover');
    Route::post('/medication/medication-round-lab1-4-2/temporary-absence', [MedicationRoundController::class, 'temporaryAbsenceLab142'])->name('medication.medication-round.lab1-4-2.temporary-absence');
    Route::get('/medication/mar-report', [MedicationRoundController::class, 'marReport'])->name('medication.mar-report');
    ...
    Route::post('/frontend2/switch-home', [Frontend2Controller::class, 'switchHome'])->name('frontend2.switch-home');
    ...
    // "Medication 2" — the real Round page. MUST be registered BEFORE the {page}
    // catch-all below: Laravel matches first-registered, and it does not prefer a
    // literal segment over a wildcard across separate declarations, so a later
    // explicit route would be shadowed and render the empty placeholder (audit CR route note).
    Route::get('/frontend2/medication-2/round', [Medication2RoundController::class, 'index'])->name('frontend2.medication2.round');
    Route::post('/frontend2/medication-2/round/record', [Medication2RoundController::class, 'record'])->name('frontend2.medication2.round.record');
    Route::post('/frontend2/medication-2/round/end', [Medication2RoundController::class, 'endRound'])->name('frontend2.medication2.round.end');
    Route::post('/frontend2/medication-2/round/reopen', [Medication2RoundController::class, 'reopenRound'])->name('frontend2.medication2.round.reopen');
    // The other Medication 2 pages — real routes, also before the catch-all, reusing the
    // existing controllers' data helpers and rendering fresh Medication 2 views.
    Route::get('/frontend2/medication-2/medications', [Frontend2Controller::class, 'medications2'])->name('frontend2.medication2.medications');
    Route::get('/frontend2/medication-2/missed-doses', [MissedDosesController::class, 'indexMedication2'])->name('frontend2.medication2.missed-doses');
    Route::post('/frontend2/medication-2/missed-doses/resolve', [MissedDosesController::class, 'resolveMedication2'])->name('frontend2.medication2.missed-doses.resolve');
    Route::post('/frontend2/medication-2/missed-doses/unresolve', [MissedDosesController::class, 'unresolveMedication2'])->name('frontend2.medication2.missed-doses.unresolve');
    ...
    Route::post('/medication/controlled-drugs', [ControlledDrugRegisterController::class, 'store'])->name('medication.controlled-drugs.store');
    // React/Inertia version (isolated; legacy above untouched)
    ...
    Route::post('/medication/stock/adjust', [MedicationStockController::class, 'adjust'])->name('medication.stock.adjust');
    // React/Inertia + Mantine pilot (isolated; legacy page above is untouched)
    Route::get('/medication/stock-react', [MedicationStockController::class, 'indexReact'])->name('medication.stock.react');
    ...
    Route::post('/medication/missed-doses/resolve', [MissedDosesController::class, 'resolve'])->name('medication.missed-doses.resolve');
    // React/Inertia version (isolated; legacy above untouched)
...
/*
|--------------------------------------------------------------------------
| Care One OS / Frontend 4
|--------------------------------------------------------------------------
| This is deliberately outside the legacy checkUserAuth group. It has its
| own guard, credentials, reset tokens, audit trail and session namespace.
| Nothing here changes /login, /logout, /admin/login or the existing APIs.
*/
Route::prefix('frontend4')->name('frontend4.')->group(function () {
    ...
    Route::get('/reset-password/{token}', [Frontend4AuthenticationController::class, 'showResetPassword'])
...
Route::group(['prefix' => 'admin', 'middleware' => 'CheckAdminAuth'], function () {
    ...
    Route::prefix('user/pay-rates')->name('payrates.')->group(function () {
        Route::get('/', [PayRatesController::class, 'index'])->name('index');
        Route::get('/add', [PayRatesController::class, 'create'])->name('create');
        Route::post('/save', [PayRatesController::class, 'store'])->name('store');
        Route::get('/edit/{id}', [PayRatesController::class, 'edit'])->name('edit');
        Route::post('/update/{id}', [PayRatesController::class, 'update'])->name('update');
        Route::get('/delete/{id}', [PayRatesController::class, 'destroy'])->name('destroy');
    });

...
class checkUserAuth
{
    ...
    public function handle($request, Closure $next, $guard = null)
    {
        ...
        if (Auth::check()) {
            ...
            if (in_array(Auth::user()->user_type, ['M', 'O', 'A']) && !Session::has('allowed_home_ids')) {
        ...
        if (!Auth::check()) {
            ...
            if ($path != '/') {
                if (in_array(Auth::user()->user_type, ['M', 'O', 'A'])) {
                    return $next($request);
                }

                            ...
                            <div class="position-center">
                                <form class="form-horizontal" role="form" method="post" action="{{ $action }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="name" class="form-control" placeholder="Name"
                                                value="{{ isset($user_info->name) ? $user_info->name : '' }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <input type="text" name="user_name" class="form-control"
                                                ...
                                                value="{{ isset($user_info->user_name) ? $user_info->user_name : '' }}"
                                                {{ isset($user_info) ? 'readonly' : '' }} maxlength="255"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <img src="{{ $image }}" id="old_image" alt="No image"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="admission_number" class="form-control"
                                                ...
                                                value="{{ isset($user_info->admission_number) ? $user_info->admission_number : '' }}"
                                                maxlength="255" {{ isset($del_status) ? $disabled : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input class="form-control date-of-birth" type="text"
                                                value="{{ isset($user_info->date_of_birth) ? date('d-m-Y', strtotime($user_info->date_of_birth)) : '' }}"
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="child_type" id="home_type">
                                                ...
                                                <option value="residential"
                                                    {{ isset($user_info->child_type) && $user_info->child_type == 'residential' ? 'selected' : '' }}>
                                                    Residential</option>
                                                <option value="accommodation"
                                                    {{ isset($user_info->child_type) && $user_info->child_type == 'accommodation' ? 'selected' : '' }}>
                                                    Supported Accomodation</option>
                                                <option value="leavers"
                                                    {{ isset($user_info->child_type) && $user_info->child_type == 'leavers' ? 'selected' : '' }}>
                                                    Leavers</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="residential_rooms" style="display: none;">
                                        ...
                                        <div class="col-lg-9">
                                            <select class="form-control" name="room_type">
                                                <option value="">Select Type </option>
                                                <option value="1"
                                                    {{ isset($user_info->room_type) && $user_info->room_type == '1' ? 'selected' : '' }}>
                                                    1 Bed Placement </option>
                                                <option value="2"
                                                    {{ isset($user_info->room_type) && $user_info->room_type == '2' ? 'selected' : '' }}>
                                                    2 Bed Placement </option>
                                                <option value="3"
                                                    {{ isset($user_info->room_type) && $user_info->room_type == '3' ? 'selected' : '' }}>
                                                    3 Bed Placement </option>
                                                <option value="4"
                                                    {{ isset($user_info->room_type) && $user_info->room_type == '4' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="weekly_rate" class="form-control"
                                                placeholder="Weekly Rate"
                                                value="{{ isset($user_info->weekly_rate) ? $user_info->weekly_rate : '' }}"
                                                maxlength="255">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="subs" class="form-control" placeholder="Subs"
                                                value="{{ isset($user_info->subs) ? $user_info->subs : '' }}"
                                                maxlength="255">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="extra" class="form-control"
                                                placeholder="Extra"
                                                value="{{ isset($user_info->extra) ? $user_info->extra : '' }}"
                                                maxlength="255">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="start_date" class="form-control date-of-birth"
                                                placeholder="DD-MM-YYYY"
                                                value="{{ isset($user_info->start_date) ? $user_info->start_date : '' }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">End Date</label>
                                        <div class="col-lg-9">
                                            <input type="text" name="end_date" class="form-control date-of-birth"
                                                value="{{ isset($user_info->end_date) ? $user_info->end_date : '' }}"
                                                placeholder="DD-MM-YYYY">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="local_authority" class="form-control"
                                                placeholder="Local Authority"
                                                value="{{ isset($user_info->local_authority) ? $user_info->local_authority : '' }}"
                                                maxlength="255">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="hair_and_eyes" class="form-control"
                                                placeholder="Hair &  Eyes"
                                                value="{{ isset($user_info->hair_and_eyes) ? $user_info->hair_and_eyes : '' }}"
                                                maxlength="255" {{ isset($del_status) ? $disabled : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="markings" class="form-control"
                                                placeholder="Markings"
                                                value="{{ isset($user_info->markings) ? $user_info->markings : '' }}"
                                                maxlength="255" {{ isset($del_status) ? $disabled : '' }}>
                                        </div>
                                    </div>
                                            ...
                                            <select class="form-control" name="ethnicity_id"
                                                ...
                                                @foreach ($ethnicity as $value)
                                                    <option value="{{ $value->id }}"
                                                        <?php if (isset($user_info->ethnicity_id)) { ?>{{ $user_info->ethnicity_id == $value->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea name="short_description" class="form-control" placeholder="Short description" rows="4"
                                                maxlength="1000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->short_description) ? $user_info->short_description : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                if (isset($user_info)) {
                                    ...
                                    $user_info->previous_location = preg_replace('#<br\s* /?>#i', "",
                                        $user_info->previous_location);
                                        $user_info->personal_info = preg_replace('#<br\s* /?>#i', "",
                                            $user_info->personal_info);
                                            $user_info->education_history = preg_replace('#<br\s* /?>#i', "",
                                                $user_info->education_history);
                                                $user_info->bereavement_issues = preg_replace('#<br\s* /?>#i', "",
                                                    $user_info->bereavement_issues);
                                                    $user_info->drug_n_alcohol_issues = preg_replace('#<br\s* /?>#i',
                                                        "", $user_info->drug_n_alcohol_issues);
                                                        $user_info->mental_health_issues = preg_replace('#<br\s* /?>#i',
                                                            "", $user_info->mental_health_issues);
                                                            } ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" name="phone_no"
                                                                        ...
                                                                        value="{{ isset($user_info->phone_no) ? $user_info->phone_no : '' }}"
                                                                        maxlength="60"
                                                                        {{ isset($del_status) ? $disabled : '' }}>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" name="mobile"
                                                                        ...
                                                                        value="{{ isset($user_info->mobile) ? $user_info->mobile : '' }}"
                                                                        maxlength="15"
                                                                        {{ isset($del_status) ? $disabled : '' }}>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Current
                                                                    Location</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="current_location" class="form-control" placeholder="Current location" rows="4"
                                                                        maxlength="1000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->current_location) ? $user_info->current_location : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Previous
                                                                    Location</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="previous_location" class="form-control" placeholder="Previous location" rows="4"
                                                                        maxlength="1000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->previous_location) ? $user_info->previous_location : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            <!--  <div class="form-group">
                                ...
                                ?>
                                                            ...
                                                            <div class="form-group">
                                                                <label
                                                                    class="col-lg-3 control-label">{{ $app_name }}</label>
                                                                <div class="col-lg-9">
                                                                    <input
                                                                        name="social_app[{{ $key }}][social_app_id]"
                                                                        type="hidden" value="{{ $social_app_id }}"
                                                                        {{ isset($del_status) ? $disabled : '' }}>
                                                                    <input
                                                                        name="social_app[{{ $key }}][su_app_id]"
                                                                        type="hidden" value="{{ $field_id }}"
                                                                        {{ isset($del_status) ? $disabled : '' }}>
                                                                    <input name="social_app[{{ $key }}][value]"
                                                                        type="text" class="form-control"
                                                                        value="{{ $field_value }}" maxlength="255"
                                                                        {{ isset($del_status) ? $disabled : '' }}>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Personal
                                                                    Information</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="personal_info" class="form-control" placeholder="Personal information" rows="6"
                                                                        maxlength="2000" {{ isset($del_status) ? $disabled : '' }}><?php echo isset($user_info->personal_info) ? $user_info->personal_info : ''; ?> </textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Education
                                                                    History</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="education_history" class="form-control" placeholder="Education history" rows="6"
                                                                        maxlength="2000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->education_history) ? $user_info->education_history : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Bereavement
                                                                    issues</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="bereavement_issues" class="form-control" placeholder="Bereavement issues" rows="6"
                                                                        maxlength="2000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->bereavement_issues) ? $user_info->bereavement_issues : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Drug & alcohol
                                                                    issues</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="drug_n_alcohol_issues" class="form-control" placeholder="Drug & alcohol issues" rows="6"
                                                                        maxlength="2000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->drug_n_alcohol_issues) ? $user_info->drug_n_alcohol_issues : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-lg-3 control-label">Mental Health
                                                                    Issues</label>
                                                                <div class="col-lg-9">
                                                                    <textarea name="mental_health_issues" class="form-control" placeholder="Mental health issues" rows="6"
                                                                        maxlength="2000" {{ isset($del_status) ? $disabled : '' }}>{{ isset($user_info->mental_health_issues) ? $user_info->mental_health_issues : '' }}</textarea>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="col-lg-offset-3 col-lg-10">
                                                                        <div class="add-admin-btn-area">
                                                                            ...
                                                                            <input type="hidden" name="user_id"
                                                                                value="{{ isset($user_info->id) ? $user_info->id : '' }}">
                                                                            <button type="submit"
                                                                                class="btn btn-primary save-btn"
                                                                                name="submit1"
                                                                                {{ isset($del_status) ? $disabled : '' }}>Save</button>
                                                                            @if (isset($del_status))
                                                                                @if ($del_status == '1')
                                                                                    <a
                                                                                        href="{{ url('admin/service-users/' . '?user=archive') }}"><button
                                                                                            type="button"
                                                                                            class="btn btn-default"
                                                                                            name="cancel">Cancel</button></a>
                                                                                @else
                                                                                    <a
                                                                                        href="{{ url('admin/service-users') }}"><button
                                                                                            type="button"
                                                                                            class="btn btn-default"
                                                                                            name="cancel">Cancel</button></a>
                                                                                @endif

                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div id="editable-sample_length" class="dataTables_length">
                                        <form method='post' action="{{ url('admin/user/sick-leaves/'.$user_id) }}" id="records_per_page_form">
                                            <label>
                                ...
                                <div class="col-lg-6">
                                    <form method='get' action="{{ url('admin/user/sick-leaves/'.$user_id) }}">

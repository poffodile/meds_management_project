            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="{{ $page == 'company_manager' ? 'active' : '' }}">
                            <a href="{{ url('admin/company-managers') }}"><span>Company Manager</span></a>
                        </li>
                        <li class="{{ $page == 'system-admins' ? 'active' : '' }}">
                            <a href="{{ url('admin/system-admins') }}"><span>Companies</span></a>
                        </li>
                        <li class="{{ $page == 'company_charges' ? 'active' : '' }}">
                            <a href="{{ url('admin/company-charges') }}"><span>Company Charges</span></a>
                        </li>
                        <li class="{{ $page == 'supr_migrations' ? 'active' : '' }}">
                            <a href="{{ url('super-admin/migrations') }}"><span>Migrations</span></a>
                        </li>

                        <li class="{{ $page == 'super_admin_user' ? 'active' : '' }}">
                            <a href="{{ url('super-admin/users') }}"><span>Super Admin Users</span></a>
                        </li>

                        <li class="{{ $page == 'file_category_name' ? 'active' : '' }}">
                            <a href="{{ url('super-admin/filemanager-categories') }}"><span>File Manager Categories</span></a>
                        </li>
                        <!-- <li class="{{ $page == 'file_category_name' ? 'active' : '' }}">
                        ...
                        <li class="{{ $page == 'social-app' ? 'active' : '' }}">
                            <a href="{{ url('super-admin/social-apps') }}"><span>Social Apps</span></a>
                        </li>
                        <li class="{{ $page == 'ethnicity' ? 'active' : '' }}">
                            <a href="{{ url('super-admin/ethnicities') }}"><span>Ethnicity</span></a>
                        </li>
                    </ul>
                </li>
                @endif
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="{{ $page == 'child_section' ? 'active' : '' }}">
                            <a href="{{ url('admin/child-sections') }}">Child Section</a>
                        </li>
                        <li class="{{ $page == 'agents' ? 'active' : '' }}">
                            <a href="{{ url('admin/agents') }}">Agent</a>
                        </li>
                        ...
                        <li class="{{ $page == 'education-training' ? 'active' : '' }}">
                            <a href="{{ url('admin/education-trainings') }}">Education Records</a>
                        </li>
                        <li class="{{ $page == 'living_skill' ? 'active' : '' }}">
                            <a href="{{ url('admin/living-skill') }}"> Independent Living Skills </a>
                        </li>
                        <!-- <li class="{{ $page == 'mfc' ? 'active' : '' }}"><a href="{{ url('admin/mfc-records') }}">MFC</a></li> -->
                        <li class="{{ $page == 'risks' ? 'active' : '' }}">
                            <a href="{{ url('admin/risk') }}">Risks</a>
                        </li>
                        <li class="{{ $page == 'earning_scheme' || $page == 'incentive_earning_scheme' ? 'active' : '' }}">
                            <a href="{{ url('admin/earning-scheme') }}">Earning Scheme </a>
                        </li>
                        <li class="{{ $page == 'earning_scheme_label' ? 'active' : '' }}">
                            <a href="{{ url('admin/earning-scheme-labels') }}">Earning Scheme Labels</a>
                        </li>
                        <li class="{{ $page == 'form-builder' || $page == 'form-builder' ? 'active' : '' }}">
                            <a href="{{ url('admin/form-builder') }}">Form Builder </a>
                        </li>
                        <li class="{{ $page == 'label' ? 'active' : '' }}">
                            <a href="{{ url('admin/labels') }}">Labels</a>
                        </li>
                        <li class="{{ $page == 'categories' ? 'active' : '' }}">
                            <a href="{{ url('admin/categories') }}">Log Category Labels</a>
                        </li>
                        <li class="{{ $page == 'support_ticket' ? 'active' : '' }}">
                            <a href="{{ url('admin/support-ticket') }}">Support Ticket</a>
                        </li>
                        <li class="{{ $page == 'modification-request' ? 'active' : '' }}">
                            <a href="{{ url('admin/modification-requests') }}">Modification Requests</a>
                        </li>
                        ...
                        <li class="{{ $page == 'daily_log_category' ? 'active' : '' }}">
                            <a href="{{ url('admin/daily-log-category') }}"> Daily Log Category </a>
                        </li>
                        <li class="{{ $page == 'daily_log_sub_category' ? 'active' : '' }}">
                            <a href="{{ url('admin/daily-log-sub-category') }}"> Daily Log Sub Category </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="<?php if (($page == 'care_team_job_title') || ($page == 'mood_title') || ($page == 'access_levels') || ($page == 'rota_shift') || ($page == 'pay_rates_type') || ($page == 'pay_rates') || ($page == 'homelist') || ($page == 'policies') || ($page == 'shift_category') || ($page == 'leaves') || ($page == 'incidenttype') || ($page == 'client_taskTyep') || ($page == 'client_taskCategory') || ($page == 'alert_type')) {
                                                        echo 'active';
                                                    } ?>">
                    ...
                    <ul class="sub">
                        <!--if($super_admin != 'S')-->
                        @if ($super_admin == 'O')
                        <li class="{{ $page == 'homelist' ? 'active' : '' }}">
                            <a href="{{ url('admin/homelist') }}">Homes</a>
                        </li>
                        @endif
                        ...
                        <li class="{{ $page == 'shift_category' ? 'active' : '' }}">
                            <a href="{{ url('admin/user/shift-category') }}">Shift Category</a>
                        </li>
                        ...
                        <li class="{{ ($page == 'stafftasktype') ? 'active' : '' }}">
                            <a href="{{ url('admin/stafftask-type') }}">Staff Task Type </a>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub pdlft">
                                ...
                                <li class="{{ ($page == 'alert_type') ? 'active' : '' }}">
                                    <a href="{{ url('admin/alert-type') }}"> <!--<i class="fa fa-paperclip"></i> --> Alert Type </a>
                                </li>
                            </ul>
                        </li>
                    </ul>

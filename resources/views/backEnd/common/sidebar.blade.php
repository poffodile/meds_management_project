    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="<?php if ($page == 'service-users' || $page == 'service-users-care-history' || $page == 'care_team' || $page == 'moods' || $page == 'su_migration_form' || $page == 'incident-report' || $page == 'external-service' || $page == 'su-dynamic-form' || $page == 'file_manager' || $page == 'service-user-my-money-history' || $page == 'service-user-my-money-request' || $page == 'service-users-log-book' || $page == 'service-users-living-skill' || $page == 'service-users-rmp' || $page == 'service-users-risk' || $page == 'service-users-earn-schm' || $page == 'service-users-bmp') {
                            ...
                            <a href="{{ url('admin/service-users') }}">Childs</a>
                        </li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="<?php if (($page == 'care_team_job_title') || ($page == 'mood_title') || ($page == 'access_levels') || ($page == 'rota_shift') || ($page == 'pay_rates_type') || ($page == 'pay_rates') || ($page == 'homelist') || ($page == 'policies') || ($page == 'shift_category') ||  ($page == 'leaves') || ($page == 'incidenttype')) {
                                                        echo 'active';
                                                    } ?>">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="<?php if ($page == 'agenda_meeting' || $page == 'petty_cash' || $page == 'log_book' || $page == 'weekly_allowance' || $page == 'staff_training' || $page == 'home_costing' || ($page == 'client_taskTyep') || ($page == 'client_taskCategory') || ($page == 'alert_type')) {
                                                        echo 'active';
                                                    } ?>">

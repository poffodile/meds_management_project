...
<main class="page-content">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <button class="borderBtn" type="button" onclick="window.location.href='{{url('/roster/incident-management')}}'"><i class=" f18 bx  bx-arrow-left-stroke"></i> Back to Incidents</button>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-lg-12">
                <div class="bBorderCard urReqSec emergencyHeader  incidentDetailHead">
                    <div class="d-flex justify-content-between">
                        <div>
                            <div class="mb-2">
                                <h5 class="h5Head mb-3"><i class="fs23  bx bx-shield me-3"></i>{{$report_details->incidentType->type}}</h5>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    @if($report_details->is_safeguarding == 1)
                                    <div>
                                        <span class="careBadg redDarkBadgesAni">SAFEGUARDING</span>
                                    </div>
                                    @endif
                                    @if($report_details->cqcNotification == 1)
                                    <div>
                                    ...
                                    <div class="userMum">
                                        <span class="title mt-0">
                                            <span>Ref: </span> {{$report_details->ref}}
                                        </span>
                                    </div>
                                </div>
        ...
        <div class="row mt20">
            ...
            <div class="col-lg-8">
                    ...
                    <div class="icndentDeFooter p24">
                        <div class="d-flex">
                            <div class="w50">
                                ...
                                <p>{{date("d/m/Y H:i",strtotime($report_details->date_time))}}</p>
                                <!-- 14/01/2026 14:35 -->
                            </div>
                            <div>
                                <p><strong>Location</strong></p>
                                <p class="mb-0">{{$report_details->location}}</p>
                                <small class="muteText">({{$report_details->location_detail ?? ""}})</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Dynamic Form Data -->
                @if($report_details->dynamic_form_id)
                @php
                $formData = \App\DynamicForm::showFormWithValue($report_details->dynamic_form_id, false);
                @endphp
                @if($formData['response'])
                <div class="emergencyMain mt20">
                    <div class="cardHeaderp p24">
                        <h5 class="h5Head mb-0">
                            Dynamic Form Details </h5>
                    </div>
                    <div class="incidentDeCon p24">
                        <div class="carer-form">
                            <div class="row" id="dynamic_form_fields">
                                {!! $formData['form_data'] !!}
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    $(document).ready(function() {
                        if (typeof viewdatawithvalueFormio === 'function') {
                            $('#formioView1').attr('id', 'formioView');
                ...
                <div class="emergencyMain mt20 aiInciDetaReport">
                    ...
                    <div class="p24">
                        <div class="incidentDeCon">
                            <h5 class="h5Head"><i class="bx bx-alert-circle fs23 me-2 redIColor"></i> Root Cause Analysis
                            </h5>
                        ...
                        <div class="mt20">
                            ...
                            <div class="inDeimpactAssest bg-orange-50 p-4 mt-4">
                                <p>
                                    <strong>Severity Level: <span class="ms-2 careBadg yellowBadges">Critical</span></strong>
                                </p>
                        ...
                        <div class="mt20">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="incidentDeCon">
                                    <div class="bg-blue-50 p-4 mt-4">
                                        <h6 class="h6Head" style="color:#1e40af"> <i class="bx bx-check-circle fs23 me-2"></i>Follow-Up Tasks Created</h6>
                                        <p>4 compliance tasks have been created and assigned to staff members. View them in the Compliance Task Center.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="emergencyMain aiInciDetaReport mt20">
                    ...
                    <div class="p24 aiRootCauseCon">
                        ...
                        <div class="p-4 rounded8 bg-orange-50 mt-4 rtcozCardInDe">
                            <p class="text-sm para"><i class="dotC me-2"></i> Presence of obstacles (furniture, equipment) near walkways</p>
                        </div>
                        <div class="p-4 rounded8 bg-orange-50 mt-4 rtcozCardInDe">
                            <p class="text-sm para"><i class="dotC me-2"></i> Lack of immediate access to assistance post-fall</p>
                        </div>
                        <div class="p-4 rounded8 bg-orange-50 mt-4 rtcozCardInDe">
                            <p class="text-sm para"><i class="dotC me-2"></i> Staff overwhelmed with care duties, limiting safety oversight</p>
                        </div>
                        <div class="mt20">
                            <h5 class="h5Head"> <i class="bx bx-shield fs23 me-2"></i>Immediate Actions Recommended</h5>
                        </div>
                        <div class="p-4 rounded8 bg-blue-50 mt-4 rtcozCardInDe">
                            <h6 class="h7Head"><i class="dotC me-2"></i> Conduct a thorough assessment of the fall site to gather more details</h6>
                            <div class="d-flex flexWrap gap-3">
                                <div> <span class="careBadg darkBlueBadg ">Assign to: Jane Wakefield</span></div>
                                <div>
                                    <p class="fs13 textBlue">As the only available administrative personnel with the authority to initiate the response.</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-4 rounded8 bg-blue-50 mt-4 rtcozCardInDe">
                            <h6 class="h7Head"><i class="dotC me-2"></i> Ensure all cleaning staff are reminded to use appropriate signage after mopping or cleaning floors.</h6>
                            <div class="d-flex flexWrap gap-3">
                                <div> <span class="careBadg darkBlueBadg ">Assign to: Jane Wakefield</span></div>
                                <div>
                                    <p class="fs13 textBlue">As the only available administrative personnel with the authority to initiate the response.</p>
                        ...
                        <div class="p-4 rounded8 bg-blue-50 mt-4 rtcozCardInDe">
                            <h6 class="h7Head"><i class="dotC me-2"></i>Notify all staff of the incident through a safety briefing to raise awareness of fall risks.</h6>
                            <div class="d-flex flexWrap gap-3">
                                <div> <span class="careBadg darkBlueBadg ">Assign to: Shaheem Navad</span></div>
                                <div>
                                    <p class="fs13 textBlue">Shaheem can mobilize the rest of the care staff for an urgent briefing due to his role.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 rounded8 bg-greenp-50 mt-4 rtcozCardInDe">
                            ...
                            <p class="fs13 textGreen">Sarah is suited to coordinate staff trainings as she holds a relevant care position.</p>
                        </div>
                        <div class="p-4 rounded8 bg-greenp-50 mt-4 rtcozCardInDe">
                            <h6 class="h7Head"><i class="dotC me-2"></i>Implement a formal cleaning protocol that includes clear signage and staff notification during and after cleaning.</h6>
                            <div class="d-flex flexWrap gap-3">
                                <div class="d-flex gap-4">
                                    <p class="muchsmallText"><span>Timeframe:</span>Within 1 month</p>
                                    <p class="muchsmallText"><span>Responsibility:</span>Manager</p>
                        ...
                        <div class="p-4 rounded8 bg-greenp-50 mt-4 rtcozCardInDe">
                            <h6 class="h7Head"><i class="dotC me-2"></i>Create a checklist for staff to complete after cleaning that includes checking for hazards and placing warning signs.</h6>
                            <div class="d-flex flexWrap gap-3">
                                <div class="d-flex gap-4">
                                    <p class="muchsmallText"><span>Timeframe:</span>Within 1 month</p>
                                    <p class="muchsmallText"><span>Responsibility:</span>Manager</p>
                            ...
                            <p class="fs13 textGreen">Emma is an admin staff member who can effectively manage procedural documentation.</p>
                        </div>
                        <div class="mt20">

            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  <p class="font-bold">Week 5 - February 2025</p>
                  <p>Processed</p>
                  <p>Feb 3 - Feb 9, 2025</p>
                  <p><strong> Pay Date:</strong> Friday, Feb 14, 2025</p>
                </div>
              </td>
            </tr>
          </tbody>
        ...
        <table class="w-full border-collapse border-spacing-0">
          <thead>
            <tr>
              ...
              <td class="border-b-2 border-main pb-3 pl-2 font-bold text-main">Staff</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Hours</td>
              ...
              <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">IN</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Pension</td>
              <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Net</td>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="border-b py-3 pl-3">1.</td>
              <td class="border-b py-3 pl-2">Montly Ali</td>
              <td class="border-b py-3 pl-2 text-center">150.30</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">44</td>
              <td class="border-b py-3 pl-2 text-center">80%</td>
              <td class="border-b py-3 pl-2 pr-3 text-right">$180.00</td>
            </tr>
            <tr>
              <td class="border-b py-3 pl-3">2.</td>
              <td class="border-b py-3 pl-2">Taxation tax</td>
              <td class="border-b py-3 pl-2 text-center">150.30</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">44</td>
            ...
            <tr>
              ...
              <td class="border-b py-3 pl-2">Bookkeeping </td>
              <td class="border-b py-3 pl-2 text-center">150.30</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">44</td>
            ...
            <tr>
              ...
              <td class="border-b py-3 pl-2">Taxation Velue</td>
              <td class="border-b py-3 pl-2 text-center">150.30</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">15</td>
              <td class="border-b py-3 pl-2 text-center">44</td>

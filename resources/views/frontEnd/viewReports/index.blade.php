...
@section('content')
                        ...
                        <div class="panel-body">
                            <div class="top-stats-panel">
                                ...
                                <ul class="gauge-meta clearfix">
                                    <li id="gauge-textfield" class="pull-left gauge-value">
                                        {{ $count['spent'] ? $count['spent'] : '0' }}</li>
                                    <li class="pull-right gauge-title">
                                        {{ $count['weekly_allowance'] ? $count['weekly_allowance'] : '0' }}</li>
                                </ul>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="top-stats-panel">
                                ...
                                <div class="star-big text-center">
                                    <div class="star-biginner">
                                        ...
                                        <span class="star-bigno"
                                            style="margin-left:40px">{{ $count['incident'] ? $count['incident'] : '0' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="top-stats-panel">
                                ...
                                <div class="bar-stats">
                                    <ul class="progress-stat-bar clearfix">
                                        <li data-percent="{{ ($record_score['daily_record'] / 25) * 100 }}%"><span
                                                class="progress-stat-percent bg-blue"></span></li>
                                        <li data-percent="{{ ($record_score['living_skill'] / 25) * 100 }}%"><span
                                                class="progress-stat-percent"></span></li>
                                        <li data-percent="{{ ($record_score['education_record'] / 25) * 100 }}%"><span
                                                class="progress-stat-percent pink"></span></li>
                                        <li data-percent="{{ ($record_score['mfc'] / 25) * 100 }}%"><span
                                                class="progress-stat-percent yellow-b"></span></li>
                                    </ul>
                                    <ul class="bar-legend">
                                        <li><span
                                                class="bar-legend-pointer bg-blue"></span>{{ $labels['daily_record']['label'] }}
                                        </li>
                                        <li><span
                                                class="bar-legend-pointer green"></span>{{ $labels['living_skill']['label'] }}
                                        </li>
                                        <li><span
                                                class="bar-legend-pointer pink"></span>{{ $labels['education_record']['label'] }}
                                        </li>
                                        <li><span class="bar-legend-pointer yellow-b"></span>{{ $labels['mfc']['label'] }}
                                        </li>
                                    </ul>
                            ...
                            <div class="top-stats-panel">
                                <div class="daily-visit">
                                    ...
                                    <div id="daily-visit-chart2"
                                        style="width:100%; height: 100px; display: block; min-height: 220px">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (report_type == 'ALL') {
                $('select[name=\'user_type\']').html("<option value='SERVICE_USER'> Child </option>" +
            ...
            $('#report_type_select').change(function() {
                ...
                if (report_type == 'ALL') {
                    ...
                    $('select[name=\'user_type\']').html("<option value=''>Select</option>" +
                    ...
                    success: function(resp) {
                        ...
                        if (resp != '') {
                            if (user_type_id == 'SERVICE_USER') {
                                $('#select_user').html(
                                    '<option value="0">Select Child</option>' + resp);
                            } else {
                                $('#select_user').html(
                                    '<option value="0">Select Staff</option>' + resp);
                            }
                        } else {
